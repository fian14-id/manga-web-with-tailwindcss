      ...
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <button className="bg-[#7f7be2] px-4 py-2 rounded-md text-white font-bold shadow-md hover:bg-indigo-500 ease-out duration-300 active:scale-90 hover:shadow-lg">
